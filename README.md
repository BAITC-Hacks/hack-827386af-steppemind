...
Интеграционный тест запускает собранное приложение на порту 3107 с отдельной временной базой, проверяет регистрацию, вход, роли, владение задачами, срок сессии и выход. Рабочие данные не изменяются. При занятом порту задайте `AUTH_TEST_PORT`.
